      ...
      <div class="section1">
        <div class="desktop-header">
          ...
          <NuxtLink to="/" class="logo" @click="handleItemClick">
            <img src="../assets/fleetautomate.png" alt="">
          </NuxtLink>
          ...
          <nav class="nav-bar">
            <ul class="nav-links">
              <div class="nav-item">
                <NuxtLink to="/"><p>Dashboard</p></NuxtLink>
              </div>
              <div class="nav-item">
                <NuxtLink to="/"><p>Vehicle Compliance</p></NuxtLink>
              </div>
              <div class="nav-item">
                <NuxtLink to="/VehicleMaintenance"><p>Vehicle Maintenance</p></NuxtLink>
              </div>
              <div class="nav-item">
                <NuxtLink to="/"><p>Job Records and Overview</p></NuxtLink>
              </div>
              <div class="nav-item">
                <NuxtLink to="/"><p>Settings</p></NuxtLink>
              </div>
            </ul>
          </nav>
